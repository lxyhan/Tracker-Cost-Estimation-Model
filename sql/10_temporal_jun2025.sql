-- Temporal holdout: June 2025 (12-month horizon, full-year staleness)
-- The most aggressive temporal stress test: how degraded is a year-old model?
-- If the model still holds an advantage over the deployed baseline at this
-- horizon, the quarterly retraining recommendation is conservative.
--
-- Output: data/raw/per_request_1pct_jun2025.csv (~3M rows)
