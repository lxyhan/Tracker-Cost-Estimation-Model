-- Temporal holdout: December 2024 (6-month horizon)
-- Stress test for the quarterly retraining recommendation: shows what
-- happens if a Firefox client misses two retraining cycles.
--
-- Output: data/raw/per_request_1pct_dec2024.csv (~3M rows)
