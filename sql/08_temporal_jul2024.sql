-- Temporal holdout: July 2024 (1-month horizon)
-- Together with Sep (3-month), Dec (6-month), Jun-2025 (12-month) this gives
-- a degradation curve, addressing supervisor concern that "longer horizons
-- unmeasured" is a limitation.
--
-- Output: data/raw/per_request_1pct_jul2024.csv (~3M rows)
